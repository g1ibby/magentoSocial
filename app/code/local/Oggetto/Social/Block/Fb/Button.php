...
/**
 * Block is responsible for displaying the login button Facebook
 *
 * @category   Oggetto
 * @package    Oggetto_Social
 * @subpackage Block
 ...
 */
class Oggetto_Social_Block_Fb_Button extends Mage_Core_Block_Template
{
    /**
    ...
    protected function _construct()
    {
        ...
        $this->_client = Mage::getSingleton('oggetto_social/fb_client');

        if (!Mage::helper('oggetto_social/fb')->isEnabled() || Mage::getSingleton('customer/session')->isLoggedIn()) {
            return;
        }

        $this->setTemplate('oggetto/social/fb/button.phtml');
    }
